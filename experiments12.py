...
def start_running(args):
    ...
    scenes  = [  './scenes/sphiral_diff_size.json',
              './scenes/switch.json']
    ...
    for scene in scenes:
        ...
        length_metrics([scene], 'Squares', None, k=k, nearest_neighbors_metrics=[''],
                       roadmap_nearest_neighbors_metric=[''], num_landmark=landmarks, exact=True, num_experiments=10,
                       )
    exit()
...
if __name__ == '__main__':
    ...
    args.file = 'results/Squares_scraps.txt'
