...
def start_running(args):
    ...
    for scene in scenes:
        ...
        length_metrics([scene], 'DRRT', None, k=k, nearest_neighbors_metrics=['', 'Euclidean'],
                       roadmap_nearest_neighbors_metric=['', 'Euclidean'], num_landmark=landmarks,prm_num_landmarks=2*landmarks, exact=True, num_experiments=10,
                       )
    exit()
...
if __name__ == '__main__':
    ...
    args.file = 'results/drrt_same_landmarks.txt'
