...
def start_running(args):
    ...
    scenes  = [  './scenes/Squares_Size/Cubic_1on1.json', './scenes/Squares_Size/Easy_1on1.json','./scenes/Squares_Size/Spiral_1on1.json','./scenes/Squares_Size/Spiral_2on2.json','./scenes/Squares_Size/Spiral_3on3.json','./scenes/sphiral_diff_size.json',
              './scenes/switch.json']
    ...
    for scene in scenes:
        ...
        if 'easy3' in scene:
        ...
        elif 'Spiral_2on2' in scene:

            landmarks = 3000
            k = 20
        elif 'Spiral_3on3' in scene:
            ...
            landmarks = 2500
            k = 15
        elif 'sphiral'  in scene or 'Spiral_1on1' in scene:
            landmarks = 3000
            k = 15
        ...
        length_metrics([scene], 'DRRT', None, k=k, nearest_neighbors_metrics=[''],
                       roadmap_nearest_neighbors_metric=[''], num_landmark=landmarks,prm_num_landmarks=2*landmarks, exact=True, num_experiments=10,
                       )
    exit()
...
if __name__ == '__main__':
    ...
    args.file = 'results/drrt_scraps.txt'
