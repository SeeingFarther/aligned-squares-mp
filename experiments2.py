...
def start_running(args):
    ...
    for scene in scenes:
        ...
        landmarks = 'dsa'
        k = 'das'
        metrics = ['','Euclidean', 'CTD', 'Epsilon_2', 'Epsilon_Inf', 'Max_L2', 'Mix_CTD', 'Mix_Epsilon_2'
                   ]
        ...
        if 'easy3' in scene:
            landmarks = 1000
            k = 15
            metrics = ['', 'Euclidean', 'CTD', 'Epsilon_2', 'Max_L2', 'Mix_CTD', 'Mix_Epsilon_2'
                       ]
        elif 'easy' in scene:
            landmarks = 1000
            k = 15
            ...
            landmarks = 1500
            k = 15
            metrics = ['','Euclidean', 'Max_L2', 'Mix_CTD', 'Mix_Epsilon_2'
                       ]
        ...
        length_metrics([scene], 'Squares', None, nearest_neighbors_metrics=metrics, k=k, num_landmark=landmarks, exact=True, num_experiments=10                      )
...
if __name__ == '__main__':
    ...
    args.file = 'results/Squares_filter_metrics_20_precent.txt'
